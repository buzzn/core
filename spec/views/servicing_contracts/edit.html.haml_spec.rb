...
RSpec.describe "servicing_contracts/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit servicing_contract form" do
    render

    assert_select "form[action=?][method=?]", servicing_contract_path(@servicing_contract), "post" do
