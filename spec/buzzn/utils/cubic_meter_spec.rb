...
describe Buzzn::Utils::CubicMeter do
  ...
  it 'instantiate via Number' do
    a = Buzzn::Utils::Number.cubic_meter(2)
    expect(a).to eq Buzzn::Utils::CubicMeter.new(2)
    expect(a).to eq cubic_meter(2)
    expect(a).to be > Buzzn::Utils::CubicMeter::ZERO
    expect(a - a).to eq Buzzn::Utils::CubicMeter::ZERO
    expect(a - a * 2).to be < Buzzn::Utils::CubicMeter::ZERO
  end
