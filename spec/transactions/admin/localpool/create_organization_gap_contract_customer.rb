...
require 'buzzn/transactions/admin/localpool/create_organization_gap_contract_customer'

describe Transactions::Admin::Localpool::CreateOrganizationGapContractCustomer do
