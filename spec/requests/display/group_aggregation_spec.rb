    ...
    context 'GET' do
      ...
      xit '200 discovergy' do
        VCR.use_cassette("request/api/v1/discovergy") do
          ...
          Timecop.freeze(time) do
            ...
            GET "/#{group.id}/charts", nil, duration: :day
            ...
            GET "/#{group.id}/charts", nil, duration: :day, timestamp: time - 1.day
            ...
            GET "/#{group.id}/charts", nil, duration: :month
      ...
      it '200 standard profile' do
        ...
        Timecop.freeze(time) do
          ...
          GET  "/#{profile_group.id}/charts", nil, duration: :day
          ...
          GET  "/#{profile_group.id}/charts", nil, duration: :day, timestamp: time - 1.day
          ...
          GET  "/#{profile_group.id}/charts", nil, duration: :month
