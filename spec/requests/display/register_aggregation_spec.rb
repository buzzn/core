  ...
  context 'registers' do
      ...
      context 'GET' do
        ...
        it '200 standard profile' do
          ...
          Timecop.freeze(time) do
            ...
            GET "/#{group.id}/registers/#{slp_register.id}/ticker", nil
    ...
    context 'charts' do
      ...
      context 'GET' do
        ...
        it '422 missing' do
          GET "/#{group.id}/registers/#{input_register.id}/charts", nil
          expect(response).to have_http_status(422)
          expect(json).to eq missing_json
        end

        it '422 wrong' do
          GET "/#{group.id}/registers/#{input_register.id}/charts", nil, duration: :century, timestamp: 'now'
          expect(response).to have_http_status(422)
        ...
        it '200 discovergy' do
          VCR.use_cassette("request/api/v1/discovergy") do
            ...
            Timecop.freeze(time) do
              ...
              GET  "/#{group.id}/registers/#{output_register.id}/charts", nil, duration: :day
              ...
              GET  "/#{group.id}/registers/#{input_register.id}/charts", nil, duration: :day, timestamp: time - 1.day
              ...
              GET  "/#{group.id}/registers/#{output_register.id}/charts", nil, duration: :month
              ...
              GET  "/#{group.id}/registers/#{input_register.id}/charts", nil, duration: :year
        ...
        it '200 standard profile' do
          ...
          Timecop.freeze(time) do
            ...
            GET  "/#{group.id}/registers/#{sep_register.id}/charts", nil, duration: :day
            ...
            GET  "/#{group.id}/registers/#{slp_register.id}/charts", nil, duration: :day, timestamp: time - 1.day
            ...
            GET  "/#{group.id}/registers/#{sep_register.id}/charts", nil, duration: :month
            ...
            GET  "/#{group.id}/registers/#{slp_register.id}/charts", nil, duration: :year
