     ...
     context 'PATCH' do
       ...
       let(:wrong_json) do
         {
           "errors"=>[
             ...
             {"parameter"=>"low_load_ability",
              "detail"=>"must be boolean"},
             {"parameter"=>"share_with_group",
              "detail"=>"must be boolean"},
             {"parameter"=>"share_publicly",
              "detail"=>"must be boolean"},
       ...
       it '422' do
         PATCH "/test/#{group.id}/meters/#{meter.id}/registers/#{register.id}", $admin,
               ...
               share_with_group: 'sometimes',
               share_publicly: 'not-really',
      ...
      let(:registers_json) do
        Register::Base.all.reload.collect do |register|
          ...
          json = {
            ...
            "last_reading"=>last ? last.value : 0,
            'share_with_group' => register.share_with_group,
            'share_publicly' => register.share_publicly,
