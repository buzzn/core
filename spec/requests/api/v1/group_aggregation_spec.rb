describe "groups" do
    ...
    context 'GET' do
      ...
      it '200 discovergy' do
        VCR.use_cassette("request/api/v1/discovergy") do
          ...
          begin
            ...
            GET "/api/v1/groups/#{group.id}/bubbles", admin
      ...
      it '200 standard profile' do
        ...
        begin
          ...
          GET "/api/v1/groups/#{profile_group.id}/bubbles", admin
  ...
  context 'charts' do
    ...
    context 'GET' do
      ...
      it '422 no params' do
        GET "/api/v1/groups/#{group.id}/charts", admin
      ...
      it '404' do
        GET "/api/v1/groups/bla-bla-bla/charts", nil, duration: :year
        expect(response).to have_http_status(404)
        expect(json).to eq not_found_json
      end
      ...
      it '200 discovergy' do
        VCR.use_cassette("request/api/v1/discovergy") do
          ...
          begin
            ...
            GET "/api/v1/groups/#{group.id}/charts", admin, duration: :hour
            ...
            GET "/api/v1/groups/#{group.id}/charts", nil, duration: :day, timestamp: time - 1.day
            ...
            GET "/api/v1/groups/#{group.id}/charts", nil, duration: :month
            ...
            GET "/api/v1/groups/#{group.id}/charts", admin, duration: :year
      ...
      it '200 standard profile' do
        ...
        begin
          ...
          GET "/api/v1/groups/#{profile_group.id}/charts", admin, duration: :hour
          ...
          GET  "/api/v1/groups/#{profile_group.id}/charts", nil, duration: :day
          ...
          GET  "/api/v1/groups/#{profile_group.id}/charts", nil, duration: :day, timestamp: time - 1.day
          ...
          GET  "/api/v1/groups/#{profile_group.id}/charts", nil, duration: :month
          ...
          GET  "/api/v1/groups/#{profile_group.id}/charts", admin, duration: :year
