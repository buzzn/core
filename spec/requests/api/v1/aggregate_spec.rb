describe "Aggregate API" do
  ...
  #
  # xit 'does aggregate multiple metering_points slp chart by year_to_months as admin' do
  # end
  #
  # xit 'does aggregate multiple metering_points slp chart by month_to_days as admin' do
  # end
  #
  # xit 'does aggregate multiple metering_points slp chart by day_to_minutes as admin' do
  # end
