  ...
  class CalculateEnergyClassification
    class << self
      def do_calculation(localpool, total_accounted_energy, full_renewable_energy_law_taxation, reduced_renewable_energy_law_taxation, eeg_ratio_kWh_per_euro)
        ...
        energy_classification_grid_consumption = localpool.contracts.power_takers.first.contractor.energy_classifications.first
        # TODO: don't take the first object, look for the appropriate object to that specific time.
        energy_classification_germany = Organization.find_by_name(Organization::GERMANY).energy_classifications.first
        # D119
        total_consumption_by_lsn = total_accounted_energy.total_consumption_by_lsn
        # F43 and D121
        known_origin = total_accounted_energy.consumption_though_chp + total_accounted_energy.grid_consumption_corrected
        # F44 and J121
        unknown_origin = total_accounted_energy.consumption_though_pv
        ...
        # I126
        known_origin_nuclear_energy = total_accounted_energy.grid_consumption_corrected * energy_classification_nuclear_consumption.coal_ratio / sum_ratios_from_grid_consumption
        # I129
        ...
        # I132
        known_origin_gas_energy = total_accounted_energy.grid_consumption_corrected * energy_classification_grid_consumption.gas_ratio / sum_ratios_from_grid_consumption
        # I135
        ...
        # I145
        known_origin_co2_emissions = energy_classification_grid_consumption.co2_emissions_gramm_per_kWh * total_accounted_energy.grid_consumption_corrected + 202 * total_accounted_energy.consumption_though_chp
        # I146
        ...
        known_origin_sum_energy_without_renewables = known_origin_sum_energy - known_origin_other_renewables_energy
        # F15
        energy_full_eeg_debt = (total_accounted_energy.consumption_though_chp + total_accounted_energy.consumption_though_pv)/total_consumption_by_lsn * end_consumers
        # F16
        energy_reduced_eeg_debt = (total_accounted_energy.consumption_though_chp + total_accounted_energy.consumption_though_pv)/total_consumption_by_lsn * (total_consumption_by_lsn - end_consumers)
        # F45 and J152
        ...
        # J156
        ratio_renewables_with_eeg = (eeg_tax_payd * eeg_ratio_kWh_per_euro) / end_consumers
        # J159
        energy_renewables_with_eeg = end_consumers * ratio_renewables_with_eeg
        ...
        # D157
        germany_co2_emissions = energy_classification_germany.co2_emissions_gramm_per_kWh * (100 / (100 - energy_classification_germany.renewables_eeg_ratio))
        # D158
        ...
        # L126
        unknown_origin_nuclear_energy = unknown_origin * germany_nuclear_ratio
        # L129
        unknown_origin_coal_energy = unknown_origin * germany_coal_ratio
        # L132
        unknown_origin_gas_energy = unknown_origin * germany_gas_ratio
        # L135
        unknown_origin_other_fossiles_energy = unknown_origin * germany_other_fossiles_ratio
        # L138
        unknown_origin_other_renewables_energy = unknown_origin * germany_other_renewables_ratio
        # L143
        ...
        # L146
        unknown_origin_nuclear_waste = unknown_origin_sum_energy * germany_nuclear_waste

        # N126
        unknown_origin_nuclear_ratio = unknown_origin_nuclear_energy / unknown_origin * 1.0
        # N129
        unknown_origin_coal_ratio = unknown_origin_coal_energy / unknown_origin * 1.0
        # N132
        unknown_origin_gas_ratio = unknown_origin_gas_energy / unknown_origin * 1.0
        # N135
        unknown_origin_other_fossiles_ratio = unknown_origin_other_fossiles_energy / unknown_origin * 1.0
        # N138
        unknown_origin_other_renewables_ratio = unknown_origin_other_renewables_energy / unknown_origin * 1.0
        ...
        # F145
        final_co2_emissions = (known_origin_co2_emissions + unknown_origin_co2_emissions) * (1 - unknown_origin_hkn / (known_origin_sum_energy_without_renewables + unknown_origin_sum_energy_without_renewables)) * (1 - eeg_rewarded_ratio)
        # F145
        final_nuclear_waste = (known_origin_nuclear_waste + unknown_origin_nuclear_waste) * (1 - unknown_origin_hkn / (known_origin_sum_energy_without_renewables + unknown_origin_sum_energy_without_renewables)) * (1 - eeg_rewarded_ratio)
