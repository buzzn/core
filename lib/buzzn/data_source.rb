module Buzzn
  ...
  class DataSource
    ...
    # @param resource [Group::Base, Register::Virtual] a group or virtual-register. can not be nil.
    ...
    # @param resource [Group::Base, Register::Real] a group or register. can not be nil. can not be nil. the register has the matching data_source.
    # @param mode [:in, :out] can not be nil.
    ...
    # @param resource [Group::Base, Register::Base] a group or register. can not be nil.
    # @param mode [:in, :out] can not be nil.
