    ...
    route do |r|
      ...
      r.get! 'ping' do
        if (rodauth.session[rodauth.session_last_activity_session_key] + rodauth.session_inactivity_timeout) < Buzzn::Utils::Chronos.now.to_i
          ...
          logger.warn Time.at(rodauth.session[rodauth.session_last_activity_session_key])
          logger.warn Time.at(rodauth.session[rodauth.session_last_activity_session_key]  + rodauth.session_inactivity_timeout)
          logger.warn Time.at(Buzzn::Utils::Chronos.now.to_i)
