# == Schema Information
#
# Table name: minipooldb.kontakt_acc_buzzndb
#
...
class Beekeeper::Minipool::KontaktAccBuzzndb < Beekeeper::Minipool::BaseRecord

  self.table_name = 'minipooldb.kontakt_acc_buzzndb'
