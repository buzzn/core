class Beekeeper::Importer::LocalpoolContracts
  ...
  def create_fake_register(buzznid, localpool)
    ...
    register = Register::Real.create!(meta: Register::Meta.create!(share_with_group: false, label: :other, name: 'FAKE-FOR-IMPORT'), meter: meter)
    MarketLocation.create!(register: register)
    register
  end
