...
#
localpool_people_power  = FactoryGirl.create(:localpool, :people_power, owner: SeedsRepository.persons.wolfgang)
...
powertakers.each do |_key, person|
  contract = FactoryGirl.create(:contract, :localpool_powertaker,
