...
class CreateBankAccounts < ActiveRecord::Migration
  ...
  def up
    ...
    add_belongs_to :bank_accounts, :owner_person, reference: :persons, index: true, null: true
    add_belongs_to :bank_accounts, :owner_organization, reference: :organizations, index: true, null: true
  ...
  def down
    ...
    remove_belongs_to :bank_accounts, :persons, index: true, null: false
    remove_belongs_to :bank_accounts, :organizations, index: true, null: false
